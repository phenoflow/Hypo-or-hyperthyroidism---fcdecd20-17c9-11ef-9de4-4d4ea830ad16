...
(async () => {
  ...
  await fs.writeFile("hypo-or-hyperthyroidism-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hypo-or-hyperthyroidism-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
